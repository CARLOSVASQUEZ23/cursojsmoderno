...
//  const cardOtro = document.querySelector('.card');
// console.log(cardOtro.parentNode);// No usar node por temas de espacios en blanco
// // console.log(cardOtro.parentElement.parentElement.parentElement);

// console.log(cardOtro);
// console.log(cardOtro.nextElementSibling); //Ver el hermano siguiente
// console.log(cardOtro.nextElementSibling.nextElementSibling);
