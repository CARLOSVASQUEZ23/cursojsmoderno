...
const parrafo1 = document.createElement('p');
parrafo1.textContent = 'paisaje';
parrafo1.classList.add('categoria', 'paisaje');

const parrafo2 = document.createElement('p');
parrafo1.textContent = 'paisaje de montañas';
parrafo1.classList.add('titulo');


const parrafo3 = document.createElement('p');
parrafo1.textContent = 'Oferta Q750';
...
// imagen.classList.add('img-fluid'); // Hacer que las imagenes sean responsive
// imagen.alt = 'texto alternativo'


//Crear el div padre card
const card = document.createElement('div');
card.classList.add('card');
